"""
Django settings for aipscm_study project.
...
SECRET_KEY = 'h^r9c4p3-a%k#71m%=(1#3k%u^^+tl_6-5itst#f!t0if%j_+b'
...
ROOT_URLCONF = 'aipscm_study.urls'
...
WSGI_APPLICATION = 'aipscm_study.wsgi.application'
